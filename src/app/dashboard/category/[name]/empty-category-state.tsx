...
//this query is written to fetch the data that contains the events for a perticular category but if they are not there then we will keep on polling the server every second to check if there are any events for that category.
//once we get the events we will refresh the page to show the events.
//so ultimately this page acts as a waiting page for the first event to come in for that category.
  const { data } = useQuery({
