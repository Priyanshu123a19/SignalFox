...
const Page = () => {
  ...
  const { data } = useQuery({
    queryFn: async () => {
        //the call gets to the place where the client is set that calls the auth router over there the getDatabaseSyncStatus is the function that is getting called
